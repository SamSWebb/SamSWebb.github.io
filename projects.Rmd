...
## <span style="color:black">**Current Funding:-**
...
### <span style="color:grey90">Establishing the minimal detectable and clinically important changes in the Oxford Cognitive Screening programme measures
...
### <span style="color:grey90">Does impairment classification method affect clinical interpretation of participant performance?

In this project, in collaboration with statisticians and psychologist researchers, we will compare Multivariate Normative Comparison methods with univariate analyses techniques to establish if the methods are sufficiently differen to warrent different clinical interpretations.  
- **Status**: Active data analysis and manuscript preparation (Oct 2024). 


### <span style="color:grey90">Development and validation of the Mini-Oxford Cognitive Screen (Mini-OCS).
