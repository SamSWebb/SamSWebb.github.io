...
## Completed: [MSc Dissertation](https://osf.io/cktj9/)
...
## Completed: [Essay on alternative facts in psychology ](https://osf.io/5wmkr/)
...
### <span style="color:deeppink"> Oxford Cognitive Screen Plus - validation and norming
...
### <span style="color:deeppink">Oxford Digital Multiple Errands Test - partial validation and norming

* This is a project in preparation which establishes the normative scoring for a new version of the widely used Multiple Errands Test which is on a computer tablet [(Shallice and Burgess, 1991)](https://www.researchgate.net/publication/21111959_Deficits_in_strategy_application_following_frontal_lobe_damage_in_man). 
...
### <span style="color:deeppink">The COMPetency ASSessment (COMPASS) - validation and norming
