...
## <span style="color:deepskyblue1">Completed:
...
## <span style="color:deepskyblue1">In progress:

### <span style="color:deepskyblue1"> [Oxford Cognitive Screen Plus](http://www.demeyerelab.org/?page_id=434) - validation and norming

* A new tool, an updated and more domain specific addition to the [Oxford Cognitive Screen](https://www.ocs-test.org/)
* This is an upcoming paper (to be published on the AMRC framework) which provides normative scoring and validation for a new assessment of the cognitive domains: language, memory, executive function, and attention. 
...
### <span style="color:">Oxford Digital Multiple Errands Test (OxMET) - partial validation and norming
...
### <span style="color:deepskyblue1">The COMPetency ASSessment [(COMPASS)](http://www.demeyerelab.org/?page_id=469) - validation and norming
